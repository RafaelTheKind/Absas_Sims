...
<body class="dashboard-page">
            ...
            <div class="content-area">s
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <button class="btn btn-primary" onclick="openStudentModal1()">
                            ...
                            <tbody id="studentsTableBody">
                                ...
                                <tr>
                                    ...
                                    <td style="white-space: nowrap;">
                                        <button class="btn btn-sm btn-secondary" onclick="viewStudent()" title="View Details">
                                            <i class="fas fa-eye"></i>
                                        </button>
                                        <button class="btn btn-sm btn-secondary" onclick="editStudent()" title="Edit">
    ...
    <div class="modal" id="studentModal1">
                    <div class="modal-content" style="max-width: 700px;">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <form method="POST" id="studentForm1" action="save-php/save-students.php">
                                <h4 style="color: var(--maroon); margin-bottom: 15px; border-bottom: 2px solid var(--gold); padding-bottom: 10px;">
                                    <i class="fas fa-id-card"></i> Basic Information
                                </h4>
                                <div class="form-grid">
                                    <div class="form-group">
                                        <label for="studentId">Student ID *</label>
                                        <input type="text" id="studentId" name="id" value="" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="lrn">LRN (Learner Reference Number) *</label>
                                        <input type="text" id="lrn" name="lrn" maxlength="12" placeholder="123456789012" required>
