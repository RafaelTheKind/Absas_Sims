                  ...
                  <?php    foreach ($rows as $row):   ?>
                                <tr>
                                    ...
                                    <td style="white-space: nowrap;">
                                        <button class="btn btn-sm btn-secondary" onclick="openStudentModal1(1)" title="View Details">
                                            <i class="fas fa-eye"></i>
                                        </button>
                                        <button class="btn btn-sm btn-secondary" onclick="openStudentModal1()" title="Edit">
