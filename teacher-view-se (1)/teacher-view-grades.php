...
$sql3 = "SELECT * FROM grade WHERE Student_Record_ID =1";
      ...
      <div class="card schedule-card">
            ...
            <table class="grades-table">
                ...
                <tbody>
                  ...
                  $final1 = round(($row3["q1_sub1"] + $row["q2_sub1"] + $row["q3_sub1"] + $row["q3_sub1"]) / 4);
                  $final2 = round(($row3["q1_sub2"] + $row["q2_sub2"] + $row["q3_sub2"] + $row["q3_sub2"]) / 4);
                  $final3 = round(($row3["q1_sub3"] + $row["q2_sub3"] + $row["q3_sub3"] + $row["q3_sub3"]) / 4);
                  $final4 = round(($row3["q1_sub4"] + $row["q2_sub4"] + $row["q3_sub4"] + $row["q3_sub4"]) / 4);
                  $final5 = round(($row3["q1_sub5"] + $row["q2_sub5"] + $row["q3_sub5"] + $row["q3_sub5"]) / 4);
                  $final6 = round(($row3["q1_sub6"] + $row["q2_sub6"] + $row["q3_sub6"] + $row["q3_sub6"]) / 4);
                  $final7 = round($final1 + $final2 + $final3 + $final4 + $final5 + $final6)/6  ;
...
?>
                    <tr>
                      ...
                      <td>
                        <?= htmlspecialchars($final1); ?>
                      </td>
                      <td>
                        <?= htmlspecialchars($final2); ?>
                        </td>
                        <td>
                        <?= htmlspecialchars($final3); ?>
                        </td>
                        <td>
                        <?= htmlspecialchars($final4); ?>
                        </td>
                        <td>
                        <?= htmlspecialchars($final5); ?>
                        </td>
                        <td>
                        <?= htmlspecialchars($final6); ?>
                        
                      </td>
                        
                        <td>
                        <?= htmlspecialchars($final7); ?>
                      </td>
                        <td>
                            ...
                            <form method="post" id="facultyForm" action="saves.php">
                                ...
                                <div class="form-grid">
                                  <div class="form-group">
                                    ...
                                    <?php
                                   $final11 = round(($row3["q1_sub1"] + $row3["q2_sub1"] + $row3["q3_sub1"] + $row3["q4_sub1"]) / 4);
                                    $final21 = round(($row3["q1_sub2"] + $row3["q2_sub2"] + $row3["q3_sub2"] + $row3["q4_sub2"]) / 4);
                                    $final31 = round(($row3["q1_sub3"] + $row3["q2_sub3"] + $row3["q3_sub3"] + $row3["q4_sub3"]) / 4);
                                    $final41 = round(($row3["q1_sub4"] + $row3["q2_sub4"] + $row3["q3_sub4"] + $row3["q4_sub4"]) / 4);
                                    $final51 = round(($row3["q1_sub5"] + $row3["q2_sub5"] + $row3["q3_sub5"] + $row3["q4_sub5"]) / 4);
                                    $final61 = round(($row3["q1_sub6"] + $row3["q2_sub6"] + $row3["q3_sub6"] + $row3["q4_sub6"]) / 4);

                                    ?>
                                        <label for="facultyId">Mathematics *</label>
                                        <input type="text" id="Mathematics" name="Mathematics" value="<?= htmlspecialchars($final11) ?>" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="employeeId">Science</label>
                                        <input type="text" id="Science" name="Science" value="<?= htmlspecialchars($final21) ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="facultyFirstName">English *</label>
                                        <input type="text" id="English" name="English"value="<?= htmlspecialchars($final21) ?>" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="facultyLastName">Filipino *</label>
                                        <input type="text" id="Filipino" name="Filipino" value="<?= htmlspecialchars($final21) ?>" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="facultyLastName">Physical Education *</label>
                                        <input type="text" id="Physical Education" name="Physical Education" value="<?= htmlspecialchars($final21) ?>" required>
                                    </div>
                                </div>
